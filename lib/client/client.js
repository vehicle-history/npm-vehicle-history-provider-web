...
exports.isExampleVehicle = function (searchCarRequest, exampleConfig) {
  return searchCarRequest.getPlate() === exampleConfig.plate &&
    ...
    searchCarRequest.getFirstRegistrationDate() === exampleConfig.firstRegistrationDate
    ;
};
...
exports.checkVehicleHistory = function (searchCarRequest, options, callback) {
  logger.debug('checkVehicleHistory: searchCarRequest:', searchCarRequest);
  exports.getVehicleHistory(searchCarRequest, options, callback);
};
