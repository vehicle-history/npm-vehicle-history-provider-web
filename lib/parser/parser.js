...
var VehicleNotFoundError = require('../error/vehicleNotFoundError').VehicleNotFoundError;
...
var getResultMap = function (result, searchCarRequest) {
...
exports.generateReport = function (body, searchCarRequest, options, callback) {
  ...
  wwwFieldsParser.parseContent(content, parserOptions, function (err, result) {
    ...
    var map = getResultMap(result, searchCarRequest);
